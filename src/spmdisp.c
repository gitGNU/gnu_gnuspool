...
char    *writer, *doswriter, *mailer, *shellname, *spuname, *homedir, *sysmsgfile;
...
/* Get message file and also values of MAILER, WRITER and DOSWRITER
   by looking at configuration files. Do it directly in the home directory
   to be consistent with the old way of doing it and in the .subdirectory */
...
MAINFN_TYPE  main(int argc, char **argv)
{
        ...
        /* And now a whole load of nonsense to delete LOGNAME from the
           environment. For some idiotic reason some versions of mail use this
