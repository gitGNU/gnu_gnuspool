...
/* Macros for giving us job numbers and printer names */

#define  JOB_NUMBER(JP)         host_prefix_long((JP)->spq_netid, (LONG) (JP)->spq_job)
#define  PTR_NAME(PP)           host_prefix_str((PP)->spp_netid, (PP)->spp_ptr)
...
#define SON_WRONGIP     60      /*  reply to probe with wrong IP giving the right one */

#define SN_NOTSERVER    61      /*  Inform scheduler not server */
#define SN_NOTNOSERV    62      /*  Uninform scheduler not server */
