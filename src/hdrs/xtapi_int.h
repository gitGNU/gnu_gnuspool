...
struct  api_fd  {
        ...
        int_ugid_t      servuid;        /* User id on server */
#ifdef  OS_PYRAMID
...
#define API_LOGIN       40
#define API_LOCALLOGIN  41
#define API_WLOGIN      42

        char    resvd[1];               /* Reserved */
        SHORT   retcode;                /* Error return/0 */
        union  {
                /* For signon or login from anywhere - may ask for password */
                struct  {
                ...
                struct  {
                        classcode_t     classcode;
                        int_ugid_t      servuid;        /* Userid at server */
                }  r_signon;
                struct  {
                        ULONG   flags;
                }  lister;
