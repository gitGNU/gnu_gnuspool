...
struct  perm    {
        ...
        { $PN{Priv descr masquerade user}, -1,  (char *) 0,     PV_MASQ, PV_MASQ, ~PV_MASQ }
};
...
#define USNAM_COL       0
#define DEFPRI_COL      10
#define MINPRI_COL      14
#define MAXPRI_COL      18
#define COPIES_COL      22
#define DEFFORM_COL     26
#define DEFPTR_COL      44
#define CLASS_COL       60
#define PRIV_COL        72
...
static void  disp_user(int unum, int row, const int andclear)
{
        ...
        if  (andclear)
                wclrtoeol(dscr);
        wprintw(dscr, "%.9s", prin_uname((uid_t) up->spu_user));
